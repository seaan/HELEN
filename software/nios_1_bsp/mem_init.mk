...
# Memory: onchip_1
MEM_1 := helen_onchip_1
$(MEM_1)_NAME := onchip_1
...
$(MEM_1)_END := 0x0400bfff
$(MEM_1)_SPAN := 0x00004000
$(MEM_1)_HIERARCHICAL_PATH := onchip_1
$(MEM_1)_WIDTH := 32
...
.PHONY: onchip_1
onchip_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
