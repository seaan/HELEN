...
module soc_system_mm_interconnect_1 (
	...
	wire          onchip_memory_0_s1_agent_rp_valid;                            // onchip_memory_0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [234:0] onchip_memory_0_s1_agent_rp_data;                             // onchip_memory_0_s1_agent:rp_data -> router_003:sink_data
	wire          onchip_memory_0_s1_agent_rp_ready;                            // router_003:sink_ready -> onchip_memory_0_s1_agent:rp_ready
	wire          onchip_memory_0_s1_agent_rp_startofpacket;                    // onchip_memory_0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          onchip_memory_0_s1_agent_rp_endofpacket;                      // onchip_memory_0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [126:0] pio_0_s1_agent_rp_data;                                       // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          cmd_mux_001_src_valid;                                        // cmd_mux_001:src_valid -> onchip_memory_0_s1_burst_adapter:sink0_valid
	wire  [234:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> onchip_memory_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                        // onchip_memory_0_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                      // cmd_mux_001:src_channel -> onchip_memory_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                // cmd_mux_001:src_startofpacket -> onchip_memory_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                  // cmd_mux_001:src_endofpacket -> onchip_memory_0_s1_burst_adapter:sink0_endofpacket
	...
	wire  [126:0] router_004_src_data;                                          // router_004:src_data -> pio_0_s1_rsp_width_adapter:in_data
	...
	wire  [234:0] pio_0_s1_rsp_width_adapter_src_data;                          // pio_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire  [234:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> pio_0_s1_cmd_width_adapter:in_data
	...
	wire          onchip_memory_0_s1_agent_rdata_fifo_out_valid;                // onchip_memory_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire  [129:0] onchip_memory_0_s1_agent_rdata_fifo_out_data;                 // onchip_memory_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          onchip_memory_0_s1_agent_rdata_fifo_out_ready;                // avalon_st_adapter_001:in_0_ready -> onchip_memory_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                            // avalon_st_adapter_001:out_0_valid -> onchip_memory_0_s1_agent:rdata_fifo_sink_valid
	wire  [129:0] avalon_st_adapter_001_out_0_data;                             // avalon_st_adapter_001:out_0_data -> onchip_memory_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                            // onchip_memory_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                            // avalon_st_adapter_001:out_0_error -> onchip_memory_0_s1_agent:rdata_fifo_sink_error
