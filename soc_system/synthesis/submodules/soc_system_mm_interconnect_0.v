...
module soc_system_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> hps_0_h2f_lw_axi_master_agent:write_rp_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> hps_0_h2f_lw_axi_master_agent:read_rp_channel
	...
	wire  [126:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [126:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire  [126:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> custom_leds_0_s0_burst_adapter:sink0_channel
	...
	wire    [4:0] custom_leds_0_s0_burst_adapter_source0_channel;                             // custom_leds_0_s0_burst_adapter:source0_channel -> custom_leds_0_s0_agent:cp_channel
