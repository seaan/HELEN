...
module helen_mm_interconnect_0 (
	...
	wire   [26:0] nios_data_master_translator_avalon_universal_master_0_address;              // nios_data_master_translator:uav_address -> nios_data_master_agent:av_address
	...
	wire  [104:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> nios_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                          // nios_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [9:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> nios_data_master_agent:rp_channel
	...
	wire   [26:0] nios_instruction_master_translator_avalon_universal_master_0_address;       // nios_instruction_master_translator:uav_address -> nios_instruction_master_agent:av_address
	...
	wire  [104:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> nios_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                      // nios_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [9:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> nios_instruction_master_agent:rp_channel
	...
	wire    [9:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> adc_adc_slave_agent:cp_channel
	...
	wire   [26:0] nios_debug_mem_slave_agent_m0_address;                                      // nios_debug_mem_slave_agent:m0_address -> nios_debug_mem_slave_translator:uav_address
	...
	wire  [105:0] nios_debug_mem_slave_agent_rf_source_data;                                  // nios_debug_mem_slave_agent:rf_source_data -> nios_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios_debug_mem_slave_agent_rsp_fifo:out_data -> nios_debug_mem_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> nios_debug_mem_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // nios_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [9:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> nios_debug_mem_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> flash_epcs_control_port_agent:cp_channel
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> altpll_pll_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> uart_s1_agent:cp_channel
	...
	wire   [26:0] onchip_s1_agent_m0_address;                                                 // onchip_s1_agent:m0_address -> onchip_s1_translator:uav_address
	...
	wire  [105:0] onchip_s1_agent_rf_source_data;                                             // onchip_s1_agent:rf_source_data -> onchip_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] onchip_s1_agent_rsp_fifo_out_data;                                          // onchip_s1_agent_rsp_fifo:out_data -> onchip_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_009_src_data;                                                       // cmd_mux_009:src_data -> onchip_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                      // onchip_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                    // cmd_mux_009:src_channel -> onchip_s1_agent:cp_channel
	...
	wire  [104:0] nios_data_master_agent_cp_data;                                             // nios_data_master_agent:cp_data -> router:sink_data
	...
	wire  [104:0] nios_instruction_master_agent_cp_data;                                      // nios_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [104:0] adc_adc_slave_agent_rp_data;                                                // adc_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [104:0] nios_debug_mem_slave_agent_rp_data;                                         // nios_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire          flash_epcs_control_port_agent_rp_valid;                                     // flash_epcs_control_port_agent:rp_valid -> router_006:sink_valid
	wire  [104:0] flash_epcs_control_port_agent_rp_data;                                      // flash_epcs_control_port_agent:rp_data -> router_006:sink_data
	wire          flash_epcs_control_port_agent_rp_ready;                                     // router_006:sink_ready -> flash_epcs_control_port_agent:rp_ready
	wire          flash_epcs_control_port_agent_rp_startofpacket;                             // flash_epcs_control_port_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          flash_epcs_control_port_agent_rp_endofpacket;                               // flash_epcs_control_port_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [104:0] altpll_pll_slave_agent_rp_data;                                             // altpll_pll_slave_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] uart_s1_agent_rp_data;                                                      // uart_s1_agent:rp_data -> router_010:sink_data
	...
	wire          onchip_s1_agent_rp_valid;                                                   // onchip_s1_agent:rp_valid -> router_011:sink_valid
	wire  [104:0] onchip_s1_agent_rp_data;                                                    // onchip_s1_agent:rp_data -> router_011:sink_data
	wire          onchip_s1_agent_rp_ready;                                                   // router_011:sink_ready -> onchip_s1_agent:rp_ready
	wire          onchip_s1_agent_rp_startofpacket;                                           // onchip_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          onchip_s1_agent_rp_endofpacket;                                             // onchip_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [104:0] cmd_demux_001_src3_data;                                                    // cmd_demux_001:src3_data -> cmd_mux_009:sink1_data
	...
	wire  [104:0] rsp_demux_009_src1_data;                                                    // rsp_demux_009:src1_data -> rsp_mux_001:sink3_data
	...
	helen_mm_interconnect_0_router_002 router_003 (
	...
	helen_mm_interconnect_0_router_002 router_004 (
	...
	helen_mm_interconnect_0_router_005 router_005 (
	...
	helen_mm_interconnect_0_router_005 router_006 (
	...
	helen_mm_interconnect_0_router_002 router_007 (
	...
	helen_mm_interconnect_0_router_002 router_008 (
	...
	helen_mm_interconnect_0_router_002 router_010 (
	...
	helen_mm_interconnect_0_router_005 router_011 (
	...
	helen_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (altpll_c0_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (altpll_c0_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                                              //       clk.clk
		.reset               (altpll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_cmd_mux_003 cmd_mux_007 (
		.clk                 (altpll_c0_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_cmd_mux_003 cmd_mux_009 (
		.clk                 (altpll_c0_clk),                          //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (altpll_c0_clk),                          //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (altpll_c0_clk),                          //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	helen_mm_interconnect_0_rsp_demux_003 rsp_demux_007 (
		.clk                (altpll_c0_clk),                                //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	helen_mm_interconnect_0_rsp_demux_003 rsp_demux_009 (
		.clk                (altpll_c0_clk),                          //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
